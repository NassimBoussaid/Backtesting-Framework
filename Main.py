...
price_data = pd.read_csv("S&P500_PX_LAST.csv", index_col=0, parse_dates=True)
backtester = Backtester(price_data, special_start=30)

per_data = pd.read_csv("S&P500_PER.csv", index_col=0, parse_dates=True)
pbr_data = pd.read_csv("S&P500_PBR.csv", index_col=0, parse_dates=True)
...
result = backtester.run(strategy, rebalancing_frequency="daily")
